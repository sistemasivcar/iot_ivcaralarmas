    ...
    <div class="col-sm-6 push-sm-6">
      <div class="p-y text-center text-sm-right">
        <a href class="inline p-x text-center">
          <span class="h4 block m-0">2</span>
...
<div class="tab-pane p-v-sm" id="tab_2">
  ...
  <div class="row">
              <div class="col-xs-6 col-sm-12">
                <div class="box p-a" align="center">
                  <div class="clear">
                      <h4 class="m-0 text-lg _300"><input  id="img_comando_alarma_id_2" onclick="act_desact_2()" width="100" height="100"type="image" name="image" src="assets/images/loading.png"><br><small><?php echo strtoupper($alias2['devices_alias']); ?>: </small><strong><b id="estado_alarma_id_2" class="text-bg">--</b></strong></h4>
